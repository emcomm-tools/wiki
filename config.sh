...
export WIKI_DESCRIPTION="Offline encyclopedia for amateur radio operators"
export WIKI_LANGUAGE="eng"
export WIKI_CREATOR="EmComm-Tools Project"
export WIKI_PUBLISHER="VA2OPS"
export WIKI_FAVICON="content/articles/images/favicon.png"
...
# Articles to fetch from Wikipedia (as array)
WIKIPEDIA_ARTICLES=(
    "Amateur_radio"
